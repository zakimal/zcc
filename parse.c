...
// Scope for local, global variables or typedefs or enum constants.
...
// Scope for struct ,union tags or enum tags.
...
// Points to a node representing a switch if we are parsing a switch statement. Otherwise, NULL.
